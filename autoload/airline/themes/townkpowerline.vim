...
let g:airline#themes#townkpowerline#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)

let g:airline#themes#townkpowerline#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
...
let g:airline#themes#townkpowerline#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
